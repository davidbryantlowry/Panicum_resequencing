...
"""
    ...
    for fil in glob.glob(indir + "/*.bam"):
...
if __name__=='__main__':
    ...
    for sample in sample_dict:
        ...
        # sample.sam.
        ofil = os.path.join(odir, sample + ".bam")
...
# Now we write the command to the parameter file. The '\' are required when you
            ...
            o.write('java -Xms1G -Xmx2G -jar /home1/01499/oakglade/bin/picard-tools-1.98/MergeSamFiles.jar INPUT=' + fout + \
                    ' OUTPUT=' + ofil + \
